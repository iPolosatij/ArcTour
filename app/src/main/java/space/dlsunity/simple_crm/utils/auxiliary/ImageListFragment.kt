package space.dlsunity.simple_crm.utils.auxiliary
...
import space.dlsunity.simple_crm.databinding.ListImageFragmentBinding
import space.dlsunity.simple_crm.presenter.base.BaseFragment
import space.dlsunity.simple_crm.utils.adapters.SelectImageRvAdapter
import space.dlsunity.simple_crm.utils.tools.DialogHelper
import space.dlsunity.simple_crm.utils.tools.ImageManager
import space.dlsunity.simple_crm.utils.tools.ImagePiker
...
class ImageListFragment(private val fragmentCloseInterface : FragmentCloseInterface) : BaseFragment(
    ...
    private fun resizeSelectedImage(newList: ArrayList<Uri>, needClear: Boolean, act: Activity){
        job = CoroutineScope(Dispatchers.Main).launch {
            ...
            val bitmapList = ImageManager.imageResize(newList, act as space.dlsunity.simple_crm.MainActivity)
            dialog.dismiss()
